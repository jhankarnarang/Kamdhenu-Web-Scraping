...
csv_file = open('accessoriesandrainwater.csv','w')
csv_writer = csv.writer(csv_file)
csv_writer.writerow(['Prod_info'])

source = requests.get('https://www.kamdhenulimited.com/kamdhenu-accessories-rainwater.php')
